      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="bg-slate-900 flex items-center justify-between h-16 md:h-20">
          <div className="flex items-center gap-2">
            <img src="https://media.base44.com/images/public/69bde2b02104755d4ffa3e40/164e888db_BBBBDELIIIII.png" alt="Brickstreet Deli" className="h-7 md:h-8 w-auto object-contain" />
          </div>
